class Project {
  ...
  Project({required this.android, required this.website, required this.play, required this.figma, this.about, this.name, this.hoverImage, this.image, this.link});
}
...
List<Project> projectList = <Project>[
  Project(
    figma:"https://www.figma.com/file/wbrfqY91ZVWuxAi0eAObJL/StreetRates-(new)-(Copy)?node-id=0%3A1&t=UoYkbYmRk4TE3usT-0" ,
      ...
      image: 'assets/rate.png', website: 'https://streetrates.info', android: ''),
  Project(
      ...
      link: '',
      image: 'assets/speak.png', play: '', website: 'https://speakbetter.fun', figma: 'https://www.figma.com/file/qpo8GjlqCgqhqlRnVROf7F/Design-leads-team-grit-team-library?node-id=1425%3A7171&t=hgnMCWRtI6Uj3Qqc-0', android: '', ),
      ...
      image: 'assets/mindPla.png', play: '', website: '', figma: 'https://www.figma.com/file/bHtVpfMQrh6BJvWuZQZjy3/SH-To-do-List-App?node-id=1%3A47&t=hgnMCWRtI6Uj3Qqc-0', android: '', ),
  Project(
      name: 'Locate Me',
      ...
      image: 'assets/locate.png', play: '', website: '', figma: '', android: '',),
      Project(
      name: 'Bub-it',
      ...
      image: 'assets/bub.png', play: '', website: '', figma: '', android: '', ),
      Project(
      name: 'Repair Home',
      ...
      image: 'assets/repair.png', play: '', website: '', figma: '', android: '',),
];
